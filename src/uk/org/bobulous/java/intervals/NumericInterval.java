...
public interface NumericInterval<T extends Number & Comparable<T>> extends
	 ...
	 * included in both intervals. If there is no value which is common to both
	 * intervals then no intersection exists between the two intervals.
	 *
 ...
 interval; <code>false</code> otherwise.
	 * @see #intersection(uk.org.bobulous.java.intervals.NumericInterval)
	 * @see #union(uk.org.bobulous.java.intervals.NumericInterval)
	 */
	 ...
	 * <p>
	 * The intersection of two intervals is the interval which includes every
	 * value permitted by both of those intervals, and includes no other values
	 * besides. If two intervals do not share any values then their intersection
	 ...
	 * @see #intersectsWith(uk.org.bobulous.java.intervals.NumericInterval)
	 */
	 ...
	 * <p>
	 * A union interval will only exist if the two given intervals intersect or
	 ...
	 * exists.
	 * @see #unitesWith(uk.org.bobulous.java.intervals.NumericInterval)
	 */
